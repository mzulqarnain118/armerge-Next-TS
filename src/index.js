...
(async function() {
  ...
  const effectList = [
    ...
    'effects/rayban_1.deepar',
    'effects/rayban2.deepar',
    'effects/rayban3.deepar',
    'effects/rayban5.deepar',
    'effects/3.deepar',
    'effects/1.deepar',
    'effects/2.deepar',
  ];
  ...
  const deepAR = await deepar.initialize({
    licenseKey: '04ec91f5f4df919c98640d0fdaeeeaa537d616bdbc5ed90441af04071a2cda6b756c1fc8b676ecd0',
    canvas: canvas,
